...
(function() {
    ...
    const SELECTORS = {
        ...
        doubleBtn: '[data-testid="double-bet-button"]', // Tombol Double
    ...
    async function executeAutoBet() {
        ...
        if (state.martingaleStep > 0) {
            ...
            const doubleBtn = Array.from(document.querySelectorAll(SELECTORS.doubleBtn)).find(el => el.offsetParent !== null);
            if (doubleBtn) {
